  ...
  return (
    <>
      <button
        ...
        className="px-5 py-2.5 text-sm font-semibold tracking-wide backdrop-blur-md bg-white/10 border border-white/25 text-white hover:bg-white/18 transition-all rounded-sm font-montserrat"
      >
        Upcoming Events
      </button>
