  ...
  return (
    <>
      <button
        ...
        className="px-5 py-2.5 border border-white/15 text-white/60 text-sm tracking-wide hover:bg-white/6 hover:text-white transition-all rounded-sm font-montserrat"
      >
        Upcoming Events
      </button>
