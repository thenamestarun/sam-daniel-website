...
const socials = [
  ...
  { href: "https://music.apple.com/gb/artist/sam-daniel/1177716347", label: "Apple Music", icon: (
  ...
  { href: "https://instagram.com/officialsamdaniel", label: "Instagram", icon: (
      ...
      >
        <div className="flex flex-col justify-start h-full px-8 pt-24 gap-0">
          ...
          <div className="flex items-center gap-5 mt-4">
            ...
            <a href="https://music.apple.com/gb/artist/sam-daniel/1177716347" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#f43f8a] transition-colors" aria-label="Apple Music">
            ...
            <a href="https://instagram.com/officialsamdaniel" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#f43f8a] transition-colors" aria-label="Instagram">
