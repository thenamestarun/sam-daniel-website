...
export default function Nav() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-8 py-4 md:py-5 backdrop-blur-md bg-black/60">
        ...
        <div className="flex flex-col justify-center h-full px-8 gap-1">
          {links.map((l, i) => (
            <Link
              key={l.href}
              href={l.href}
              className={`font-montserrat py-4 text-4xl font-bold tracking-tighter uppercase border-b border-white/6 transition-all duration-200 ${
