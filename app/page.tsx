  ...
  return (
    <div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <FadeIn>
          <div className="flex items-center gap-4 mb-8">
            <span className="text-[#f43f8a] text-sm sm:text-base tracking-widest uppercase font-semibold">Featured Release</span>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <FadeIn>
          <div className="flex items-center gap-4 mb-6">
            <span className="text-[#f43f8a] text-sm sm:text-base tracking-widest uppercase font-semibold">Featured Video</span>
            <div className="h-px flex-1 bg-white/6" />
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <FadeIn>
          <div className="flex items-center gap-4 mb-6">
            <span className="text-[#f43f8a] text-sm sm:text-base tracking-widest uppercase font-semibold">About</span>
            <div className="h-px flex-1 bg-white/6" />
          </div>
        </FadeIn>
        <FadeIn delay={80}>
        ...
        <FadeIn>
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-2">
              <span className="text-[#f43f8a] text-sm sm:text-base tracking-widest uppercase font-semibold">Upcoming</span>
