      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 gap-4 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 w-full max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
            <Link href="/music" className="font-montserrat px-5 py-2.5 text-sm font-semibold tracking-wide backdrop-blur-md bg-white/8 border border-white/20 text-white hover:bg-white/14 hover:border-white/35 transition-all rounded-sm">
              View Music
            </Link>
