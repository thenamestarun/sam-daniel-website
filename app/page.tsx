    ...
    <div className="pt-24">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 gap-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/images/hero.jpg" alt="Sam Daniel" fill className="object-cover object-center opacity-25" priority />
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-3 mt-2">
            <Link
              href="/music"
              className="px-6 py-3 rounded-full backdrop-blur-md bg-[#f472b6]/15 border border-[#f472b6]/30 text-[#f472b6] font-semibold text-sm hover:bg-[#f472b6]/25 hover:border-[#f472b6]/50 transition-all"
            >
              Listen Now
            </Link>
      ...
      <section className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="relative aspect-square rounded-2xl overflow-hidden">
            <Image src={aboutImageUrl} alt="Sam Daniel" fill className="object-cover object-top" />
      ...
      <section className="relative h-56 md:h-80 overflow-hidden my-20">
        <Image src="/images/performance.jpg" alt="Sam Daniel performing" fill className="object-cover object-top opacity-35" />
      ...
      <section className="max-w-5xl mx-auto px-6 py-10 pb-24">
        ...
        <div className="grid gap-2">
          {displayEvents.map((e: { _id: string; name: string; dateLabel?: string; date?: string }) => (
            <div key={e._id} className="flex items-center justify-between px-5 py-4 rounded-xl bg-white/4 border border-white/6 hover:border-[#f472b6]/20 hover:bg-white/6 transition-all">
