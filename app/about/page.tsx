...
const portableComponents = {
  marks: {
    link: ({ value, children }: { value?: { href: string }; children: React.ReactNode }) => (
      <a href={value?.href} target="_blank" rel="noopener noreferrer" className="text-[#f43f8a] hover:text-[#ec4899] underline underline-offset-2 transition-colors">
        {children}
      </a>
    ),
  },
